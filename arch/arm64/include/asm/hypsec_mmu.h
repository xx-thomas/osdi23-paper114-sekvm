...
// alexvh: 0x40000000000UL is start of HYP VA range, which is probably not a good thing
// so changed to 0x50000000000UL. Still double mapped.
#define EL2_PAGE_OFFSET			0x50000000000UL
